package com.sanshit.jhipster.app.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.sanshit.jhipster.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.sanshit.jhipster.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
